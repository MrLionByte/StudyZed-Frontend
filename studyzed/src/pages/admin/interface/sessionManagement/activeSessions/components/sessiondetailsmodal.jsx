   ...
   <Card className="w-[450px]">
      ...
      <CardContent>
        <div className="space-y-2">
          ...
          <div>
            <strong>Subscription Type:</strong> {SessionData.subscription_type} month
          </div>
          <div>
      ...
      <div className="flex justify-between p-4">
        ...
        <Button onClick={(e)=>handleSessionApproval(e)} className="hover:bg-red-600" variant="outline">
          Approve
        </Button>
