...
export default function TutorStudentlogin ({ passwordForgot }){
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            console.log('ERROR :', auth_status);
            if (auth_status === "user-notexsist") {
              setEmailError('This mail is not registred here.');
              // setPasswordError('')
              ...
              <div className="relative">
                ...
                <div className="relative">
                    ...
                    <button
                        ...
                        className="absolute top-1/2 right-2 -translate-y-1/2 flex items-center text-slate-300" 
