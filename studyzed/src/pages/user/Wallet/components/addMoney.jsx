...
import api,{api_dictatory as api_dictionary} from "../../../../api/axios_api_call";
...
export default function CardWithForm({cancelModal, accountNumber}) {
    ...
    const handleSubmit = async (e) => {
      ...
      try{
        ...
        const response = await api.post(TutorEndPoints.AddToWallet, 
          transactionData,{
          baseURL: url,
        });
  ...
  return (
    ...
    <Card className="w-[350px]">
      <CardHeader>
        ...
        <CardDescription>Add money to wallet for easy to use.</CardDescription>
      </CardHeader>
      <CardContent>
          ...
          <div className="grid w-full items-center gap-4">
            ...
            <div className="flex flex-col space-y-1.5 justify-center items-center w-full">
              <div className="text-center">
                    ...
                    <Input id="amount" type="number" min="100" max='10000' step="any"
                     value={amount} 
