...
export default function CreateAssessment({ handleClose }) {
  const [assessment, setAssessment] = useState(false); // Toggles between assessment details and question addition
    ...
    setNewAssessment((prev) => ({
      ...
      questions: [
        ...(prev.questions || []),
        {
          ...
          max_score: newQuestion.maxScore || 10,
          options:
