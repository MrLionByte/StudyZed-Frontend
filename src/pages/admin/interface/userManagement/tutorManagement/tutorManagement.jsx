...
export default function TutorManagement() {
  const { tutors, handleBlockUser } = useTutorManagement();
              ...
              >
                {tutor.profile ? (
                  <img
                    src={
                      tutor.profile
                        ? tutor.profile.profile_picture.replace(
                            'image/upload/',
                            '',
                          )
                        : ''
                ...
                {tutor.is_active ? (
                  <button
                    ...
                    onClick={(e) =>
                      confirmationToast(e, tutor.id, false, tutor.username)
                    }
                  >
                    BLOCK USER
                  </button>
                  ...
                  <button
                    ...
                    onClick={(e) =>
                      confirmationToast(e, tutor.id, true, tutor.username)
                    }
                  >
                    UNBLOCK USER
                  </button>
