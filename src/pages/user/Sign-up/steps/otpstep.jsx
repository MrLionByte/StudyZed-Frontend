...
export default function OtpStep ({onNext, onBack}) {
    ...
    <div className="flex-1">
        <p className="text-sm text-gray-300 mb-6 mt-3">Welcome to StudyZed! Let's begin your journey</p>
        ...
        <div className="mt-5">
            <a href="" className="text-center p-2 hover:text-emerald-400" onClick={handleBack}>
