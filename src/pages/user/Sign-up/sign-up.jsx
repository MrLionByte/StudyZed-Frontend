        ...
        <div className="h-screen flex items-center justify-center">
            ...
            <div className="md:w-1/2 p-8 content-center">
                ...
                <h5 className="text-3xl font-bold text-center">Verify</h5>
                    ...
                    <>
                <h5 className="text-2xl font-bold text-center">Learn, Grow, Succeed</h5>
                <p className="text-md font mt-2 text-gray-400">Finish your step and be a part of StudyZed</p>
                    </>
                )}
