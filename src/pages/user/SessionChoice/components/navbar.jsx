    ...
    <div className="container mx-auto px-4">
      <div className="flex items-center justify-between h-16">
        ...
        <div className="flex items-center space-x-4">
          {userRole === "STUDENT" ? (
            <Link to="/student/choose-session" className="hover:text-emerald-400">
              Home
            </Link>
          ) : (
            <Link to="/tutor/choose-session" className="hover:text-emerald-400">
              Home
            </Link>
          )}
          {userRole === "STUDENT" ? (
            <Link to="/student/student-wallet/" className="hover:text-emerald-400">
              Wallet
            </Link>
          ) : (
            <Link to="/tutor/tutor-wallet/" className="hover:text-emerald-400">
              Wallet
            </Link>
          )}
          <button
