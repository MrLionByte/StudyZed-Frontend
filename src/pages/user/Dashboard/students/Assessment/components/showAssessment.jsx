          ...
          {assessmentData ? (
            <>
              ...
              <p className="text-gray-400">
                {assessmentData.Assessment.assessment_description}
              </p>
              <p className="text-gray-400">
                Date:{' '}
                {new Date(assessmentData.Attempted.started_on).toLocaleString()}
              </p>
              <p className="text-gray-400">
                      ...
                      {q.question_type === 'OPEN' ? (
                        <div className="mt-2">
                          ...
                          <p className="text-white">
                            {userResponse?.open_response || 'No Answer'}
                          </p>
                          <p className="text-gray-400">
                            Mark Obtained: {userResponse?.mark ?? 'Not Graded'}
                          </p>
                        </div>
                      ) : (
                        <div className="space-y-2 mt-2">
                          <div className="mt-2 ">
                            <div className="flex gap-3">
                              ...
                              <p
                                className={` ${selectedOption?.is_correct ? 'text-green-400' : 'text-red-400'}`}
                              >
                                {selectedOption
