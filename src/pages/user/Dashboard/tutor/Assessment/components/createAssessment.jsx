...
export default function CreateAssessment({ handleClose, fetchFromBackend }) {
    ...
    setNewAssessment((prev) => ({
      ...
      questions: [
        ...(prev.questions || []),
        {
          ...
          question_type:
            newQuestion.type === 'multiple-choice' ? 'MLC' : 'OPEN',
  ...
  const saveAssessment = async () => {
    if (
      !newAssessment.title ||
      !newAssessment.start_time ||
      !newAssessment.end_time ||
      !newAssessment.questions?.length
    ) {
      setError(
        'All fields including title, time, and at least one question are required.',
      );
      return;
    }
    ...
    const finalAssessment = {
      ...
      assessment_description:
        newAssessment.description || 'No description provided',
    ...
    try {
      ...
      const response = await api.post(
        TutorEndPoints.CreateNewAssessment,
        finalAssessment,
        {
          baseURL: url,
        },
