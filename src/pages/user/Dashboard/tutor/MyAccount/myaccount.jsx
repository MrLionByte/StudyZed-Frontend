...
import { GraduationCap, LayoutDashboard, ClipboardList, MessagesSquare, School, LineChart, Users, User, Bell, Wallet, LogOut, Camera, Edit2, Shield, Key, Mail, HelpCircle } from 'lucide-react';
            ...
            <div className="flex">
              ...
              <div className="w-1/3 border-r border-gray-200">
                <div className="p-6 text-center">
                  ...
                  <p className="text-sm text-gray-500 mt-1">Member since Sept 2023</p>
                </div>
                ...
                {activeTab === 'profile' && (
                  <div>
                    ...
                    <div className="space-y-6">
                      <div>
                        <h3 className="text-gray-500 text-sm font-medium mb-2">Full Name</h3>
                      ...
                      <div>
                        <h3 className="text-gray-500 text-sm font-medium mb-2">Phone Number</h3>
                        <p className="text-gray-800">+1 (555) 123-4567</p>
                      </div>
                      
                      <div>
                        <h3 className="text-gray-500 text-sm font-medium mb-2">Role</h3>
                        <p className="text-gray-800">Mathematics Tutor</p>
                      </div>
                      
                      <div>
                        <h3 className="text-gray-500 text-sm font-medium mb-2">Bio</h3>
                        <p className="text-gray-800">
                          Mathematics educator with 8+ years of experience teaching high school and college-level courses. 
                          Specialized in calculus, algebra, and statistics with a passion for making complex concepts accessible to all students.
                        </p>
                      </div>
                      
                      <div>
                        <h3 className="text-gray-500 text-sm font-medium mb-2">Subjects</h3>
                        <div className="flex flex-wrap gap-2">
                          <span className="bg-teal-100 text-teal-800 px-3 py-1 rounded-full text-sm">Calculus</span>
                          <span className="bg-teal-100 text-teal-800 px-3 py-1 rounded-full text-sm">Algebra</span>
                          <span className="bg-teal-100 text-teal-800 px-3 py-1 rounded-full text-sm">Statistics</span>
                          <span className="bg-teal-100 text-teal-800 px-3 py-1 rounded-full text-sm">Geometry</span>
                        </div>
                      </div>
                    </div>
                  </div>
                    ...
                    <div className="space-y-6">
                      <div className="p-4 border border-gray-200 rounded-lg">
                        <div className="flex justify-between items-center">
                          ...
                          <button className="text-teal-600 hover:text-teal-800">Change</button>
                        </div>
                      </div>
                        ...
                        <div className="flex justify-between items-center">
                          <div className="flex items-center space-x-3">
                            ...
                            <div>
                              ...
                              <p className="text-sm text-gray-500">Enabled via Email</p>
                            </div>
                          </div>
                          <button className="text-teal-600 hover:text-teal-800">Manage</button>
                        </div>
                      </div>
                    ...
                    <div className="space-y-6">
                      <div className="p-4 border border-gray-200 rounded-lg">
                        ...
                        <div className="space-y-3">
                          ...
                          <div className="flex items-center justify-between">
                            <label className="text-gray-700">Assignment updates</label>
                            <label className="relative inline-flex items-center cursor-pointer">
                              <input type="checkbox" className="sr-only peer" defaultChecked />
                              <div className="w-11 h-6 bg-gray-200 peer-focus:outline-none rounded-full peer peer-checked:after:translate-x-full peer-checked:after:border-white after:content-[''] after:absolute after:top-[2px] after:left-[2px] after:bg-white after:border-gray-300 after:border after:rounded-full after:h-5 after:w-5 after:transition-all peer-checked:bg-teal-600"></div>
                            </label>
                          ...
                          <div className="flex items-center justify-between">
                            <label className="text-gray-700">Student progress reports</label>
                            <label className="relative inline-flex items-center cursor-pointer">
                              <input type="checkbox" className="sr-only peer" defaultChecked />
                              <div className="w-11 h-6 bg-gray-200 peer-focus:outline-none rounded-full peer peer-checked:after:translate-x-full peer-checked:after:border-white after:content-[''] after:absolute after:top-[2px] after:left-[2px] after:bg-white after:border-gray-300 after:border after:rounded-full after:h-5 after:w-5 after:transition-all peer-checked:bg-teal-600"></div>
                            </label>
                          ...
                          <div className="flex items-center justify-between">
                            <label className="text-gray-700">Platform announcements</label>
                            <label className="relative inline-flex items-center cursor-pointer">
                      ...
                      <div className="p-4 border border-gray-200 rounded-lg">
                        ...
                        <div className="space-y-3">
                          ...
                          <div className="flex items-center justify-between">
                            <label className="text-gray-700">Assignment deadlines</label>
                            <label className="relative inline-flex items-center cursor-pointer">
                              <input type="checkbox" className="sr-only peer" defaultChecked />
                              <div className="w-11 h-6 bg-gray-200 peer-focus:outline-none rounded-full peer peer-checked:after:translate-x-full peer-checked:after:border-white after:content-[''] after:absolute after:top-[2px] after:left-[2px] after:bg-white after:border-gray-300 after:border after:rounded-full after:h-5 after:w-5 after:transition-all peer-checked:bg-teal-600"></div>
                            </label>
                          ...
                          <div className="flex items-center justify-between">
                            <label className="text-gray-700">Student activity</label>
                            <label className="relative inline-flex items-center cursor-pointer">
                              <input type="checkbox" className="sr-only peer" defaultChecked />
                              <div className="w-11 h-6 bg-gray-200 peer-focus:outline-none rounded-full peer peer-checked:after:translate-x-full peer-checked:after:border-white after:content-[''] after:absolute after:top-[2px] after:left-[2px] after:bg-white after:border-gray-300 after:border after:rounded-full after:h-5 after:w-5 after:transition-all peer-checked:bg-teal-600"></div>
                            </label>
                  ...
                  <div>
                    ...
                    <div className="space-y-6">
                      <div className="p-4 border border-gray-200 rounded-lg">
                        ...
                        <div className="flex justify-between items-center">
                          <div>
                            <p className="text-lg font-semibold">Professional Tutor</p>
                        ...
                        <div className="mt-4 flex space-x-3">
                          <button className="text-teal-600 hover:text-teal-800">Change Plan</button>
                          <button className="text-red-600 hover:text-red-800">Cancel Subscription</button>
                        </div>
                      </div>
                      ...
                      <div className="p-4 border border-gray-200 rounded-lg">
                        ...
                        <div className="flex items-center justify-between p-3 bg-gray-50 rounded mb-3">
                          ...
                          <span className="bg-teal-100 text-teal-800 px-3 py-1 rounded-full text-sm">Default</span>
                        </div>
                        <button className="text-teal-600 hover:text-teal-800 text-sm">+ Add Payment Method</button>
                      </div>
                        ...
                        <div className="overflow-x-auto">
                          <table className="min-w-full divide-y divide-gray-200">
                            ...
                            <tbody className="bg-white divide-y divide-gray-200">
                              <tr>
                                <td className="px-4 py-3 whitespace-nowrap text-sm text-gray-900">May 15, 2025</td>
                                <td className="px-4 py-3 whitespace-nowrap text-sm text-gray-900">$49.99</td>
                    ...
                    <div className="space-y-6">
                        ...
                        <div className="space-y-4">
                          <details className="group">
                            ...
                            <p className="text-gray-600 mt-3 group-open:animate-fadeIn">
                              To schedule a tutoring session, navigate to the "My Class" section and click on "Schedule Session". 
                              Select the date, time, and student(s) you want to tutor, then click "Confirm".
                            </p>
                          </details>
                          ...
                          <details className="group">
                            ...
                            <p className="text-gray-600 mt-3 group-open:animate-fadeIn">
                              Payments are processed automatically on the 15th of each month. You can view your payment history 
                              and update your payment method in the "Billing & Payments" section.
                            </p>
                          </details>
                          ...
                          <details className="group">
                            ...
                            <p className="text-gray-600 mt-3 group-open:animate-fadeIn">
                              Go to the "Assessment" section to create new assessments. You can choose from various question types 
                              and set due dates. Once created, you can assign them to individual students or entire classes.
                            </p>
                          </details>
                        </div>
                      </div>
                      ...
                      <div className="p-4 border border-gray-200 rounded-lg">
                        ...
                        <p className="text-gray-600 mb-4">
                          Need additional help? Our support team is available 24/7 to assist you with any questions or issues.
                        </p>
                        <div className="space-y-4">
                          <div className="flex items-center space-x-3">
                            <Mail className="h-5 w-5 text-gray-600" />
                      ...
                      <div className="p-4 border border-gray-200 rounded-lg">
                        ...
                        <div className="space-y-3">
                          <a href="#" className="flex items-center space-x-2 text-teal-600 hover:text-teal-800">
