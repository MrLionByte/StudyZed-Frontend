...
export default function Messaging() {
    ...
    useEffect(() => {
        ...
        const connectWebSocket = () => {
            const ws = new WebSocket(`ws://localhost:8006/ws/chat/${selectedUser.student_code}/?token=${user_data.accessToken}`);
                    ...
                    <Card className="flex-1 flex flex-col">
                        <div className="flex items-center p-4 border-b">
                            <div className="flex items-center space-x-4">
                                ...
                                />
                                <div>
                                    <h2 className="text-lg font-semibold">{selectedUser.student_code}</h2>
