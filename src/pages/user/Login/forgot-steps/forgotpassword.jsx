...
export default function ForgotPassword({ passwordForgot }) {
  const forgot_paragraph =
    'Forgot your account’s password? Enter your email address and we’ll send you a recovery OTP.';
  const otp_paragraph =
    "Confirm your email using the OTP sent to your Email, Enter the OTP below. Don't reload or close your browser.";
  const password_paragraph =
    "Enter your new password here, don't reload or close your browser. Use a Capital, small, symbol and number";
  ...
  return (
    <div className="flex-1 size-80">
      ...
      <div className="flex justify-between">
        <p
          className="text-end text-slate-400 hover:text-green-600 cursor-pointer"
        ...
        {emailVarified && (
          <p
            className="text-end text-slate-400 hover:text-red-600 cursor-pointer"
